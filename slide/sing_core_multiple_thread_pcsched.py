...
saved_figure_name = "single_core_multiple_thread_pcsb"
...
ax.annotate('DIM off', xy=(0.175, 500), horizontalalignment='center', fontsize=12, color='black', zorder=4,
            bbox=dict(
                # facecolor='#e8e8e8',
                facecolor='oldlace',
                edgecolor='none',
...
ax.annotate('DIM on', xy=(0.325, 500), horizontalalignment='center', fontsize=12, color='black', zorder=10,
            path_effects=[
                path_effects.Stroke(linewidth=0.1, foreground='black'),
                path_effects.Normal()
            ])
