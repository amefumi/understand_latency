...
if __name__ == "__main__":
    ...
    x = np.arange(len(client_abs_vruntimes))
    y_client = client_abs_vruntimes
    y_combined = combined_metrics
    ...
    x = np.arange(len(server_abs_vruntimes))
    y_server = server_abs_vruntimes
    y_combined = combined_metrics
