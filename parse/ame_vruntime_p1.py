...
def main():
    ...
    for n, f, io, d, p, perm, h, s, core, run in combinations:
        ...
        plt.yscale('log')
        # plt.legend()
        plt.savefig(f'./results/{hd}_{our_patch}_{n*core}_{io}_{d}_client_{run}_reorder.pdf')
        plt.close()
        ...
        plt.yscale('log')
        # plt.legend()
        plt.savefig(f'./results/{hd}_{our_patch}_{n*core}_{io}_{d}_server_{run}_reorder.pdf')
        plt.close()
