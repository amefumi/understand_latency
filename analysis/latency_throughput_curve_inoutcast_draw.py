...
saved_file_name = "latency_throughput_incast"
# saved_file_name = "latency_throughput_dimon"
saved_figure_name = "latency_throughput_curve_incast"
...
max_latency = 600
max_throughput = 0.45
divider = 0.27 # for incast
# divider = 0.3 # for outcast
...
ax.annotate('DIM off', xy=(divider/2, max_latency * 0.4), horizontalalignment='center', fontsize=14, color='black', zorder=4,
            bbox=dict(
                # facecolor='#e8e8e8',
                facecolor='oldlace',
                edgecolor='none',
...
ax.annotate('DIM on', xy=(0.35, max_latency * 0.4), horizontalalignment='center', fontsize=14, color='black', zorder=10,
            path_effects=[
                path_effects.Stroke(linewidth=0.1, foreground='black'),
                path_effects.Normal()
            ])
...
ax.set_xticks(np.arange(0, max_throughput+0.03, 0.1), ["0", "0.1", "0.2", "0.3", "0.4"])
