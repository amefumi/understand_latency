...
saved_figure_name = "latency_throughput_curve_iodepth_250113"
...
for serie_index, serie_name in enumerate(series):
    ...
    if serie_index == 1:
        ...
        ax.plot(1.01724, 413, color='orange', zorder=10, marker='s', markersize=14, markerfacecolor='none', markeredgewidth=2)
        # 322.00000,0.84390
        ax.plot(0.85352, 304, color='red', zorder=10, marker='o', markersize=14, markerfacecolor='none', markeredgewidth=2)
    if serie_index == 2:
        # 613.00000,0.42525
        ax.plot(0.45247, 463, color='red', zorder=10, marker='o', markersize=14, markerfacecolor='none', markeredgewidth=2)
    ...
    if serie_index == 0:
        legend = ax.legend(loc='upper left', markerfirst=False, labelspacing=0.1, facecolor='white', edgecolor='white', framealpha=1)
