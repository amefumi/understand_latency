...
if __name__ == "__main__":
    ...
    experiments = [       
        ...
        "airq_understanding_19_1/52_64_1_1_1_1_0_0_1_0",
        "airq_understanding_19_1/52_64_1_1_1_1_0_0_1_1",
        "airq_understanding_19_1/52_64_1_1_1_1_0_0_1_2",
        "airq_understanding_19_1/52_64_1_1_1_1_0_0_1_3",
        "airq_understanding_19_1/52_64_1_1_1_1_0_0_1_4",
    ]
    ...
    for index, experiment, n_thread, label in zip(range(len(experiments)), experiments, n_threads, labels):
        ...
        # client_abs_vruntimes = [v - min_residual for v in client_abs_vruntimes]

        bar_width = 0.3
        ax_vruntime_bar.bar(np.array(thread_indices) - bar_width/2, client_abs_vruntimes, width=bar_width, label="Absolute virtual runtime (subtracted)", edgecolor="forestgreen", hatch='\\\\\\', fill=False, linewidth=2)
        ...
        # ax_vruntime_bar.set_ylim(5e7, 6e7)
        ...
        # server_abs_vruntimes = [v - min_residual for v in server_abs_vruntimes]

        bar_width = 0.3
        ax_vruntime_bar.bar(np.array(thread_indices) - bar_width/2, server_abs_vruntimes, width=bar_width, label="Absolute virtual runtime (subtracted)", edgecolor="forestgreen", hatch='\\\\\\', fill=False, linewidth=2)
        ax_vruntime_bar.bar(np.array(thread_indices) + bar_width/2, combined_metrics, width=bar_width, label=f"Modeled runtime", edgecolor="firebrick", hatch='///', fill=False, linewidth=2)
        ax_vruntime_bar.set_xlabel("Thread Index")
        ax_vruntime_bar.set_ylabel("Absolute vruntime")
        ax_vruntime_bar.legend()
