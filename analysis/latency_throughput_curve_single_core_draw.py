...
saved_figure_name = "latency_throughput_curve_single_core_250204"
...
bbox_latency = Bbox.from_bounds(
    ...
    latency_px.y0,
    latency_px.width + 40,
    latency_px.height + 10,
)

to_in = fig.dpi_scale_trans.inverted()
bbox_latency = bbox_latency.transformed(to_in)

fig.savefig(os.path.join(result_dir, f'{saved_figure_name}.pdf'), bbox_inches=bbox_latency)