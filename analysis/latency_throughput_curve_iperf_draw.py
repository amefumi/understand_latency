...
saved_file_name = "latency_throughput_iperf_1"
# saved_file_name = "latency_throughput_dimon"
saved_figure_name = "latency_throughput_curve_iperf_1"
experiments = ["combined_nirq", "combined_dirq", "combined_sirq"]
...
ax.set_yticks(np.arange(0, max_latency+50, 2000))
