...
saved_file_name = "latency_throughput_apache_helloworld"
# saved_file_name = "latency_throughput_dimon"
saved_figure_name = "latency_throughput_curve_apache_helloworld_focus"
...
for experiment_index, experiment_name in enumerate(experiments):
    ...
    num_threads, avg_lat999, avg_throughput = data[:, 0], data[:, 1], data[:, 2]/1000
...
ax.set_yticks(np.arange(0, max_latency+50, 200))
