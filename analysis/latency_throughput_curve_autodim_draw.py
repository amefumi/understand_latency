...
colors = ["#497ade", "#639d4e", "#8c17f6", "#b77294"]
markers = [
...
saved_figure_name = "latency_throughput_curve_autodim_260114"
experiments = ["combined_sirq", "combined_pcbs", "combined_autodim"]
# experiments = ["nirq_breakdown_1_1"] #, "dirq_breakdown_1_1", "airq_breakdown_1_1"]
# saved_file_name = "latency_throughput_dimon"
# saved_figure_name = "latency_throughput_dimon"
# experiments = ["nirq_breakdown_1_1", "dirq_breakdown_1_1", "airq_breakdown_1_1"]

labels = ["Linux + ACCa", "Linux + PCSched", "Linux + PCSched + AutoDIM"]
...
# ax.annotate('DIM off', xy=(0.125, max_latency * 0.5), horizontalalignment='center', fontsize=10, color='#696969', zorder=10,
#             path_effects=[
#                 path_effects.Stroke(linewidth=0.3, foreground='#696969'),
#                 path_effects.Normal()
#             ])
# ax.annotate('DIM on', xy=(0.325, max_latency * 0.5), horizontalalignment='center', fontsize=10, color='#5a6b72', zorder=10,
#             path_effects=[
...
# draw a red circle at (0.27, 260)
ax.plot(0.272, 296, color='orange', zorder=10, marker='s', markersize=14, markerfacecolor='none', markeredgewidth=2)
ax.plot(0.314, 266, color='orange', zorder=10, marker='s', markersize=14, markerfacecolor='none', markeredgewidth=2)
ax.plot(0.332, 898, color='red', zorder=10, marker='o', markersize=14, markerfacecolor='none', markeredgewidth=2)
...
ax.set_yticks(np.arange(0, max_latency+100, 250))
