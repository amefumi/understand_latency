...
if __name__ == "__main__":
    ...
    fig_latency_client.savefig(os.path.join(result_dir, f"rx_sched_vs_softirq_packet_client_single_core_260120.pdf"), bbox_inches=bbox)
    ...
    fig_latency_server.savefig(os.path.join(result_dir, f"rx_sched_vs_softirq_packet_server_single_core_260120.pdf"), bbox_inches=bbox_server)
