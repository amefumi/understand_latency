...
saved_figure_name = "latency_throughput_curve_single_core_autodim_log"
...
ax.annotate('DIM off', xy=(0.125, max_latency * 0.5), horizontalalignment='center', fontsize=14, color='black', zorder=4,
            bbox=dict(
                facecolor='oldlace',
                edgecolor='none',
            ),
...
ax.annotate('DIM on', xy=(0.325, max_latency * 0.5), horizontalalignment='center', fontsize=14, color='black', zorder=10,
            path_effects=[
                path_effects.Stroke(linewidth=0.1, foreground='black'),
                path_effects.Normal()
            ])
...
target_points = [
    ...
    (0.357, 276),   # Linux + PCSched
    (0.35581, 215), # Linux + PCSched + AutoDIM
]
...
legend = ax.legend(loc='upper left', markerfirst=False, labelspacing=0.15, facecolor='oldlace', edgecolor='oldlace', framealpha=1)
