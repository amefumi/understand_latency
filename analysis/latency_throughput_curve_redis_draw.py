...
saved_file_name = "latency_throughput_redis_ycsb_b"
# saved_file_name = "latency_throughput_dimon"
saved_figure_name = "latency_throughput_redis_ycsb_b_260204"
experiments = ["combined_nirq", "combined_sirq", "combined_pcbs", "combined_autodim"]
# experiments = ["nirq_breakdown_1_1"] #, "dirq_breakdown_1_1", "airq_breakdown_1_1"]
# saved_file_name = "latency_throughput_dimon"
# saved_figure_name = "latency_throughput_dimon"
# experiments = ["nirq_breakdown_1_1", "dirq_breakdown_1_1", "airq_breakdown_1_1"]

labels = ["Linux", "Linux + ACCa", "Linux + PCSched", "Linux + PCSched + AutoDIM"]
...
for experiment_index, experiment_name in enumerate(experiments):
    ...
    num_threads, avg_throughput, avg_lat999 = data[:, 0], data[:, 1], data[:, 2]
...
ax.set_xticks(np.arange(0, max_throughput+10, 40))
...
ax.set_yticks(np.arange(0, max_latency+100, 500))
