...
def parse_all_thread_info(experiment_dir, filename, total_threads=None):
    ...
    for line in lines[1:]:
        ...
        # (4) per-stage average lfb_occ / lfb_cyc, summed over stages.
        ...
        for s in stages:
            ...
            sum_lfb_occ += int(vals[col[f'{s}_lfb_occ']]) / count
            sum_lfb_cyc += int(vals[col[f'{s}_lfb_cyc']]) / count
        t.avg_ref = avg_ref
        t.avg_sum_lfb_occ = sum_lfb_occ / sum_lfb_cyc if sum_lfb_cyc > 0 else 0.0

        # (5) difference inclusive references into per-level hits, model CPU
        # cycles by charging each level's hit count its serve cost (an L3
        # reference is served at L3 since no DRAM counter is collected), then
        # divide by the per-thread LFB occupancy to discount for memory-level
        # parallelism.
        avg_hit = {
        ...
        t.modeled_cycles = (t.modeled_cycles_raw / t.avg_sum_lfb_occ
                            if t.avg_sum_lfb_occ > 0 else 0.0)
...
if __name__ == "__main__":
    ...
    experiments = [
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_0",
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_1",
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_2",
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_3",
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_4",
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_5",
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_6",
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_7",
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_8",
        "sirq_rdpmc_lfb_nofence_light_1/48_64_1_1_1_1_0_0_1_9"
    ]
    ...
    out_dir = "/data0/projects/latency/rdpmc_model_results_nofence_light_lfb"
    ...
    for exp_index, experiment in enumerate(experiments):
        ...
        lfb_path = os.path.join(
            out_dir, f"rdpmc_modeled_lfb_{save_idx[exp_index]}_server.pdf")
