...
labels = ["Linux", "Linux + ACCa", "Linux + PCSched", "Linux + PCSched + AutoDIM"] #"Linux + PCSched + NewStart"]
...
ax.plot(4.685/16, 562.00000, color='red', zorder=10, marker='o', markersize=14, markerfacecolor='none', markeredgewidth=2)
