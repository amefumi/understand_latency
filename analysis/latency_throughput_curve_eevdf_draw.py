...
colors = ["#bf1a15", "#497ade", "#8c17f6", "#b77294"]
...
# labels = ["Linux", "Linux + IRQa", "Linux + ACCa", "Linux + PCSched"]
labels = ["EEVDF", "EEVDF + ACCa", "EEVDF + ACCa + AutoDIM"]
...
ax.plot(0.298, 341, color='orange', zorder=10, marker='s', markersize=14, markerfacecolor='none', markeredgewidth=2)
ax.plot(0.344, 297, color='orange', zorder=10, marker='s', markersize=14, markerfacecolor='none', markeredgewidth=2)
...
ax.set_xticks(np.arange(0, max_throughput+0.01, 0.1))
...
ax.set_yticks(np.arange(0, max_latency+1, 200))
