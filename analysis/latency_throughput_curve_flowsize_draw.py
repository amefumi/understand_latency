...
saved_file_name = "latency_throughput_flowsize_1024"
# saved_file_name = "latency_throughput_dimon"
saved_figure_name = "latency_throughput_curve_flowsize_1024"
...
ax.annotate('DIM off', xy=(0.125, max_latency * 0.4), horizontalalignment='center', fontsize=14, color='black', zorder=4,
            bbox=dict(
                # facecolor='#e8e8e8',
                facecolor='oldlace',
                edgecolor='none',
...
ax.annotate('DIM on', xy=(0.325, max_latency * 0.4), horizontalalignment='center', fontsize=14, color='black', zorder=10,
            path_effects=[
                path_effects.Stroke(linewidth=0.1, foreground='black'),
                path_effects.Normal()
            ])
...
ax.set_yticks(np.arange(0, max_latency+400, 500))
