...
def process_experiment(result_dir, experiment, n_thread, save_id):
    ...
    client_breakdown_path = os.path.join(experiment_dir, f"latencies-{n_thread*16}.log")
    server_breakdown_path = os.path.join(experiment_dir, f"latencies-{n_thread*16}-server.log")
    ...
    client_save_path = os.path.join(experiment_dir, f"sched_client_{n_thread*16}.txt")
    server_save_path = os.path.join(experiment_dir, f"sched_server_{n_thread*16}.txt")
