...
experiments = ["sirq_pcbs_breakdown_cores_2_1"]
saved_file_name = "latency_throughput_inc_cores"
...
def parse_experiment(experiment_name):
    ...
    experiment_data = np.zeros((len(cores), 3))
    data_index = 0
    ...
    for n, f, i, d, p, perm, h, s, core in combinations:
        ...
        experiment_data[data_index, :] = [core, latency999, throughput/core]
        data_index += 1
        print(f"Experiment {experiment_name}, core={core}, latency p999: {latency999}, throughput: {throughput/core}")
