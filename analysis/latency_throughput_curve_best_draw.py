...
series = [
    "latency_throughput_best_2threads",
    "latency_throughput_best_8threads",
    "latency_throughput_best_32threads",
...
for serie_index, serie_name in enumerate(series):
    ...
    #     ax.axvspan(0, divider, facecolor='#e8e8e8', zorder=0)
    #     ax.axvspan(divider, max_throughput, facecolor='#d9eaf1', zorder=0)
    #     ax.annotate('DIM off', xy=(0.5, 1600), horizontalalignment='center', fontsize=10, color='#696969', zorder=10,
    #                 bbox=dict(
    #                     facecolor='#e8e8e8',
    #                     edgecolor='none',
    #                 ),
    #                 path_effects=[
    #                     path_effects.Stroke(linewidth=0.3, foreground='#696969'),
    #                     path_effects.Normal()
    #                 ])
    #     ax.annotate('DIM on', xy=(1.5, 1600), horizontalalignment='center', fontsize=10, color='#5a6b72', zorder=10,
    #                 bbox=dict(
    #                     facecolor='#d9eaf1',
    #                     edgecolor='none',
    #                 ),
    #                 path_effects=[
    #                     path_effects.Stroke(linewidth=0.3, foreground='#5a6b72'),
    #                     path_effects.Normal()
    #                 ])
    # else:
    #     ax.axvspan(0, max_throughput, facecolor='#d9eaf1', zorder=0)
    ...
    for experiment_index, experiment_name in enumerate(experiments):
        ...
        num_threads, avg_lat999, avg_throughput = data[:, 0], data[:, 1], data[:, 2]/16
    ...
    # if serie_index == 0:
    #     # 131.00000,1.45256
    #     ax.plot(1.45256, 131, color='red', zorder=10, marker='o', markersize=14, markerfacecolor='none', markeredgewidth=2)
    # if serie_index == 1:
    #     # 24.00000,417.00000,1.003590000
    #     ax.plot(1, 417, color='orange', zorder=10, marker='s', markersize=14, markerfacecolor='none', markeredgewidth=2)
    #     # 322.00000,0.84390
    #     ax.plot(0.8439, 322, color='red', zorder=10, marker='o', markersize=14, markerfacecolor='none', markeredgewidth=2)
    # if serie_index == 2:
    #     # 613.00000,0.42525
    #     ax.plot(0.42525, 613, color='red', zorder=10, marker='o', markersize=14, markerfacecolor='none', markeredgewidth=2)
    ...
    ax.set_xlabel('Throughput per core (million IOPS)', labelpad=8)
    ...
    ax.set_yscale('log')
    ax.set_yticks([10, 100, 1000, 10000, 100000], ["10", "10$^2$", "10$^3$", "10$^4$", "10$^5$"])
    ...
    fig.savefig(os.path.join(result_dir, f'{saved_figure_name}_{serie_index}.pdf'), bbox_inches=bbox)