...
# Define parameters
hd="sirq_breakdown_nosmt"
# hd="sirq_smt_probe"
our_patch="2"
# our_patch="1"
c_state="1"
num_apps = [1, 2, 4, 8, 12, 14, 16, 18, 20, 22]
# num_apps = [36, 44]
...
def main():
    ...
    if smt_enabled:
        print("SMT is enabled. Please disable SMT before running this script.")
        return
    ...
    for n, f, i, d, p, perm, h, s, core, run in combinations:
        ...
        command = f"./linux-both-8c-compute-nosmt.sh {n * core} {DIR} {f} {i} {d} {p} {perm} {h} {s} {core} {run} {dim_monitor}"
        print(command)
