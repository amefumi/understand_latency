...
for g in /sys/devices/system/cpu/cpu{32..47}/cpuidle/state{1,2}/disable /sys/devices/system/cpu/cpu{96..111}/cpuidle/state{1,2}/disable; do
  echo 1 | sudo tee "$g"
done
