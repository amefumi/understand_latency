...
our_patch="nofence_light_2CTer_nolat"
c_state="1"
# num_apps = [1, 2, 4, 8, 12, 16,]
# num_apps = [36, 44]
# num_apps = [1, 2, 4, 8, 12, 16, 24, 32, 36, 40, 44, 48, 52, 56, 60, 64, 72, 80]
num_apps = [48]
flowsize = [64]
iodepth = [1]
dim = [1]
...
def main():
    ...
    for n, f, i, d, p, perm, h, s, core, run in combinations:
        ...
        command = f"./linux-both-8c-compute-nolat.sh {n * core} {DIR} {f} {i} {d} {p} {perm} {h} {s} {core} {run} {dim_monitor}"
        print(command)
