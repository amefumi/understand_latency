...
hd="sirq_pcbs_autodim_heter"
our_patch="2"
c_state="1"
# num_apps = [1, 2, 4, 8, 12, 16,]
# num_apps = [36, 44]
num_apps = [4, 8, 12, 16, 24, 32, 36, 40, 44, 48, 52, 56, 60, 64, 72, 80]
# num_apps = [4, 8, 12, 16]
# num_apps = [48]
flowsize = [64]
iodepth = [1]
...
def main():
    ...
    for n, f, i, d, p, perm, h, s, core, run in combinations:
        ...
        DIR = "/data1/projects/latency/{}_{}_{}/{}_{}_{}_{}_{}_{}_{}_{}_{}_{}".format(hd, our_patch, c_state, n, f, i, d, p, perm, h, s, core, run)
        ...
        command = f"./linux-both-8c-compute-heter.sh {n * core} {DIR} {f} {i} {d} {p} {perm} {h} {s} {core} {run} {dim_monitor}"
        print(command)
