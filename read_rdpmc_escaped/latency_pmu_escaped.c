...
static const struct counter_cfg counters[NUM_COUNTERS] = {
	{ "LONGEST_LAT_CACHE.MISS@0", EVT(0x2E, 0x41), 0, false, 0, 0 },
	{ "LONGEST_LAT_CACHE.MISS@1", EVT(0x2E, 0x41), 1, false, 0, 0 },
	{ "LONGEST_LAT_CACHE.MISS@2", EVT(0x2E, 0x41), 2, false, 0, 0 },
	{ "LONGEST_LAT_CACHE.MISS@3", EVT(0x2E, 0x41), 3, false, 0, 0 },
	{ "LONGEST_LAT_CACHE.MISS@4", EVT(0x2E, 0x41), 4, false, 0, 0 },
	{ "LONGEST_LAT_CACHE.MISS@5", EVT(0x2E, 0x41), 5, false, 0, 0 },
	{ "LONGEST_LAT_CACHE.MISS@6", EVT(0x2E, 0x41), 6, false, 0, 0 },
	{ "LONGEST_LAT_CACHE.MISS@7", EVT(0x2E, 0x41), 7, false, 0, 0 },
};
...
static int __init latency_pmu_init(void)
{
	...
	if (ret) {
		pr_err(DRV_NAME ": could not reserve PMCs (NMI watchdog still on? perf busy?)\n");
